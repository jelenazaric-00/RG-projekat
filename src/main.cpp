...
int main(){
    ...
    glm::vec3 lightColor = glm::vec3(0.3f, 0.2f, 0.9f);
  ...
  // lighting info
    const unsigned int NR_LIGHTS = 9;
    ...
    while (!glfwWindowShouldClose(window)){
        ...
        if(ssaoButton==true){
            ...
            shaderGeometryPass.setMat4("model", model);
            lightHouse.Draw(shaderGeometryPass);
            //rocks
            model = glm::mat4(1.0f);
