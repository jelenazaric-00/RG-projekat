...
int main(){
 ...
 /*   lightPositions.push_back(lighthousePosition);
    lightPositions.push_back(boatPosition);
    lightPositions.push_back(rocksPosition);
    lightPositions.push_back(bigTailPosition);
    lightPositions.push_back(glm::vec3(2.0f, 1.0f,-2.2f));
    lightPositions.push_back(glm::vec3(3.5f, 2.5f,-1.2f));
    lightPositions.push_back(glm::vec3(3.0f, 2.5f,-1.5f));
    lightPositions.push_back(glm::vec3(0.0f,4.3f,-0.0f));
    lightPositions.push_back(glm::vec3(1.0f,4.5f,-1.5f));*/
    // shader configuration
    shaderLightingPassDS.use();
